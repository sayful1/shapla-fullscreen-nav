 ...
 * Description: A stylish and lighweight Full Screen Navigation for Shapla WordPress Theme.
 * Version:     1.0.0
 * Author:      Sayful Islam
...
class Shapla_FullScreen_Nav
{
    ...
    {
        wp_enqueue_style( 'shapla-fullscreen-nav', SHAPLA_FULLNAV_ASSETS . '/css/style.min.css', array(), SHAPLA_FULLNAV_VERSION, 'all' );
        wp_enqueue_script( 'shapla-fullscreen-nav', SHAPLA_FULLNAV_ASSETS . '/js/functions.min.js', array(), SHAPLA_FULLNAV_VERSION, true );
    }
    ...
    public function fullscreen_nav_html()
    {
        ...
        <div class="NavLines">
            <div class="NavLines-one"></div>
            <div class="NavLines-two"></div>
            <div class="NavLines-three"></div>
            <div class="NavLines-four"></div>
            <div class="NavLines-five"></div>
            <div class="NavLines-six"></div>
        </div>
